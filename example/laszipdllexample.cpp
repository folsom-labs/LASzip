...
void byebye(bool error=false, bool wait=false, laszip_POINTER laszip=0)
{
  if (error)
  {  
    dll_error(laszip);
...
extern void example_one(int argc, char* file_name_in, char* file_name_out, double start_time)
extern void example_two(int argc, char* file_name_in, char* file_name_out, double start_time)
extern void example_there(int argc, char* file_name_in, char* file_name_out, double start_time)
extern void example_four(int argc, char* file_name_in, char* file_name_out, double start_time)
...
int main(int argc, char *argv[])
{
  ...
  {
    example_one(argc, file_name_in, file_name_out, start_time);
  }
  ...
  {
    example_three(argc, file_name_in, file_name_out, start_time);
  }

  if (EXAMPLE == EXAMPLE_FOUR)
  {
    example_four(argc, file_name_in, file_name_out, start_time);
  }
